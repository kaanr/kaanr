...
### Привет, Мир 👋
Я скромный джун-разработчик), два родных языка - калмыцкий и русский, говорю и думаю на русском, пишу на Python, SQL, JavaScript.
...
- 🤔 Может кто поможет в создании из меня блокчейн-разработчика)).
